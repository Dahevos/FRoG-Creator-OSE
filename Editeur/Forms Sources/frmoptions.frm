...
Private Sub editcls_Click()
    ...
    frmclasseseditor.force.Text = ReadINI("CLASS", "STR", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.def.Text = ReadINI("CLASS", "DEF", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.vit.Text = ReadINI("CLASS", "SPEED", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.magi.Text = ReadINI("CLASS", "MAGI", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.carted.Text = ReadINI("CLASS", "MAP", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.xd.Text = ReadINI("CLASS", "X", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.yd.Text = ReadINI("CLASS", "Y", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.arme.Text = ReadINI("STARTUP", "Weapon", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.bouclier.Text = ReadINI("STARTUP", "Shield", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.armure.Text = ReadINI("STARTUP", "Armor", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.caske.Text = ReadINI("STARTUP", "Helmet", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.ajf.Text = ReadINI("CLASSCHANGE", "AddStr", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.ajd.Text = ReadINI("CLASSCHANGE", "AddDef", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.ajv.Text = ReadINI("CLASSCHANGE", "AddSpeed", App.Path & "\Classes\Class" & classe & ".ini")
    frmclasseseditor.ajm.Text = ReadINI("CLASSCHANGE", "AddMagi", App.Path & "\Classes\Class" & classe & ".ini")
