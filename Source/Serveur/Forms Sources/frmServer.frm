...
For Index = 1 To MAX_PLAYERS
    If IsPlaying(Index) = True Then
        ...
        Call SendHP(Index)
        Call PlayerMsg(Index, "Vous avez été soigner par l'admin du serveur!", BrightGreen)
    End If
Next Index
End Sub
...
Private Sub scrlRainIntensity_Change()
    lblRainIntensity.Caption = "Intensité : " & Val(scrlRainIntensity.value)
